...
const ROUTES: { label: string; route: string }[] = [
  ...
  { label: 'Onboarding step 1', route: '/onboarding/step/1' },
  { label: 'Home tab',          route: '/(tabs)/home' },
  { label: 'Today overview',    route: '/home/today' },
  { label: 'Health score',      route: '/home/health-score' },
  { label: 'Quick actions',     route: '/home/quick-actions' },
  { label: 'Home detail',       route: '/home/detail' },
  { label: 'Care tab',          route: '/(tabs)/care' },
  { label: 'New appointment',   route: '/care/appointments/new' },
  { label: 'Medical history',   route: '/care/medical-history' },
  { label: 'Visit prep',        route: '/care/visit-prep' },
  { label: 'Attachment upload', route: '/care/attachment-upload' },
  { label: 'Join video visit',  route: '/care/join-video' },
