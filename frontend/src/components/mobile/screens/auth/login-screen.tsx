...
export function LoginScreen({ theme = 'theme-calm', error = false }: LoginScreenProps) {
  return (
    <PhoneShell theme={theme as 'theme-calm' | 'theme-night' | 'theme-warm'}>
      ...
      <div className="screen-body" style={{ padding: '0 24px 24px' }}>
        ...
        <div style={{ marginTop: 24 }}>
          ...
          <div style={{ textAlign: 'right', fontSize: 13, color: 'var(--brand)', fontWeight: 600, marginTop: -4, marginBottom: 18 }}>
            Forgot password?
          </div>
